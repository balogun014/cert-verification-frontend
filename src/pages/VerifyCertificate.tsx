...
const VerifyCertificate = () => {
  ...
  const handleVerify = async (e) => {
    ...
    setResult(null);
    try {
      const res = await axios.post('https://cert-verification-backend-ny9g.onrender.com/verify', { hash });
      ...
      <main className="flex-1 py-12 px-4 container mx-auto max-w-4xl">
        ...
        <Card className="shadow-md">
          <CardHeader>
            ...
            <CardDescription>Enter the certificate hash provided on your certificate</CardDescription>
          </CardHeader>
